...
אנחנו נבצע שני פעולות על הטבלה כדי להכין את הנתונים לניתוח:
...
בדקו את הקובץ שנוצר (הוא יימצא בתיקיית העבודה שלכם) והעלו אותו, יחד עם שני קבצי הקוד, לתיבת ההגשה של יחידה זו.
